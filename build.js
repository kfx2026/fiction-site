...
<div id="reader-tb" style="position:fixed;bottom:0;left:0;right:0;z-index:200;background:rgba(10,11,16,0.96);border-top:1px solid rgba(255,255,255,0.06);padding:8px 0;padding-bottom:max(8px,env(safe-area-inset-bottom));backdrop-filter:blur(10px);transition:opacity 0.3s,transform 0.3s;opacity:0.9;transform:translateY(0)">
  <div style="max-width:600px;margin:0 auto;padding:0 12px;display:flex;align-items:center;justify-content:space-between">
    <button onclick="event.stopPropagation();fvFontDown()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:0.8rem;font-family:inherit">A−</button>
    <span id="fv-font-val" style="font-size:0.62rem;color:var(--dim);min-width:30px;text-align:center">18</span>
    <button onclick="event.stopPropagation();fvFontUp()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:0.8rem;font-family:inherit">A+</button>
    <div style="width:1px;height:20px;background:rgba(255,255,255,0.06)"></div>
    <button id="fv-theme-btn" onclick="event.stopPropagation();fvToggleTheme()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:1rem;font-family:inherit">🌙</button>
    <button id="fv-mode-btn" onclick="event.stopPropagation();fvToggleMode()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:1rem;font-family:inherit">📃</button>
    <button id="fv-bm-btn" onclick="event.stopPropagation();fvToggleBM()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:1rem;font-family:inherit;opacity:0.5">🏷</button>
    <button onclick="event.stopPropagation();fvToggleDrawer()" style="padding:8px 10px;border-radius:6px;border:none;background:transparent;color:var(--dim);cursor:pointer;font-size:1rem;font-family:inherit">☰</button>
  </div>
</div>
...
<div id="fv-page-nav" style="display:none;max-width:800px;margin:0 auto;padding:0 16px 8px;text-align:center">
  <span style="display:inline-flex;align-items:center;gap:16px">
    <button onclick="event.stopPropagation();fvPrevPage()" style="padding:6px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.02);color:var(--dim);cursor:pointer;font-size:0.75rem;font-family:inherit">◀ Prev</button>
    <span id="fv-page-ofs" style="font-size:0.7rem;color:var(--dim)">1/1</span>
    <button onclick="event.stopPropagation();fvNextPage()" style="padding:6px 14px;border-radius:6px;border:1px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.02);color:var(--dim);cursor:pointer;font-size:0.75rem;font-family:inherit">Next ▶</button>
  </span>
</div>
...
<div id="reader-ov" onclick="fvToggleDrawer()" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.4);z-index:399"></div>
